...
if (senha.length() != 2) {
    ...
    System.out.println("Nome: " + nome);
        ...
        if (opcao.equals("1")){
            ...
            if (Postagem.length() > Postagem_limite || !Postagem.matches("[a-zA-Z0-9-,À-Ö~!?;:.\\s]*")) {
            ...
            if (Postagem_dois.length() > Postagem_limite || !Postagem_dois.matches("[a-zA-Z0-9-,À-Ö~!?;:.\\s]*")) {
                System.out.println("Sua postagem foi postada com sucesso!\nTitulo:\n" + titulo_postagem_dois + "\nPostagem:\n" + Postagem_dois + "\n");
            } else {
            ...
            if (Postagem_tres.length() > Postagem_limite || !Postagem_tres.matches("[a-zA-Z0-9-,À-Ö~!?;:.\\s]*")) {
                System.out.println("Sua postagem excedeu o limite de caracteres e ou, possui caracteres especiais\nTente novamente!");
            } else {
            ...
            if (post == Limite_postagem) {
                System.out.println("\nVocê atingiu o limite de posts permitidos :D");
                System.out.println("Segue todos os posts feitos por você!\n" +
                        "\nTítulo:\n" + titulo_postagem + "\nPostagem:\n" + Postagem + "\n" +
                        "\nTítulo:\n" + titulo_postagem_dois + "\nPostagem:\n" + Postagem_dois + "\n" +
                        "\nTítulo:\n" + titulo_postagem_tres + "\nPostagem:\n" + Postagem_tres + "\n");
                }
